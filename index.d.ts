/**
 * this file is for typings produced by `npm run compile:dev` in scenarios in which the library is developed at the same time
 * with a library based on this one
