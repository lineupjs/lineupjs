...
function sortOrder(node: HTMLElement, column: Column, idPrefix: string) {
  ...
  node.insertAdjacentHTML('afterbegin', `
        ...
        <label><input type="radio" name="grouped" value="true" ${enabled ? 'checked' : ''} ><span>Enabled</span></label>
        <label><input type="radio" name="grouped" value="false" ${!enabled ? 'checked' : ''} ><span>Disabled</span></label>
