...
export default class HierarchyColumn extends ValueColumn<string> implements ICategoricalColumn {
  ...
  override on(type: typeof HierarchyColumn.EVENT_CUTOFF_CHANGED, listener: typeof cutOffChanged | null): this;
  override on(
    type: typeof HierarchyColumn.EVENT_COLOR_MAPPING_CHANGED,
    listener: typeof colorMappingChanged_HC | null
  ): this;
  ...
  override restore(dump: IColumnDump, factory: ITypeFactory): Set<string> {
    ...
    this.colorMapping = restoreTypedValue(
      ...
      changed,
      [
        HierarchyColumn.EVENT_COLOR_MAPPING_CHANGED,
    ...
    this.currentMaxDepth = restoreValue(dump.maxDepth, this.currentMaxDepth, changed, [
      HierarchyColumn.EVENT_CUTOFF_CHANGED,
      Column.EVENT_DIRTY_HEADER,
      Column.EVENT_DIRTY_VALUES,
      Column.EVENT_DIRTY,
    ]);
    if (typeof dump.cutOffNode !== 'undefined' && this.currentNode.path !== dump.cutOffNode) {
