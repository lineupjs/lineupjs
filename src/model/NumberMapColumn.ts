...
export default class NumberMapColumn extends MapColumn<number> implements IAdvancedBoxPlotColumn {
  ...
  override restore(dump: IColumnDump, factory: ITypeFactory): Set<string> {
    ...
    this.sort = restoreValue(dump.sortMethod, this.sort, changed, NumberMapColumn.EVENT_SORTMETHOD_CHANGED);
  ...
  override on(
    type: typeof NumberMapColumn.EVENT_COLOR_MAPPING_CHANGED,
    listener: typeof colorMappingChanged_NMC | null
  ): this;
  override on(type: typeof NumberMapColumn.EVENT_MAPPING_CHANGED, listener: typeof mappingChanged_NMC | null): this;
  override on(
    type: typeof NumberMapColumn.EVENT_SORTMETHOD_CHANGED,
    listener: typeof sortMethodChanged_NMC | null
  ): this;
  override on(type: typeof NumberMapColumn.EVENT_FILTER_CHANGED, listener: typeof filterChanged_NMC | null): this;
