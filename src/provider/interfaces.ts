import {Column, Ranking, IColumnDesc, IGroup, IndicesArray, IDataRow, IRankingDump, EAggregationState, INumberColumn, IColorMappingFunctionConstructor, IMappingFunctionConstructor} from '../model';
