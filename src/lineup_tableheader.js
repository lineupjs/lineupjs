...
//    console.log("update Header");
    ...
    var allHeadersEnter = allHeaders.enter().append("g").attr({
        ...
        .call(function(d){that.addResortDragging(this)})
    ...
    allHeadersEnter.filter(function(d){return !(d instanceof LayoutEmptyColumn);}).append("rect").attr({
        "class":"weightHandle",
    ...
    var deleteButton = allHeaders.selectAll(".singleColumnDelete").data(function(d){return (!(d instanceof LayoutStackedColumn) && d.parent==null)?[d]:[]});
...
//                .origin(function(d) { return d; })
    ...
    function dragmove(d) {
        ...
        var y = d3.event.y;
        dragHeader.attr({
            "transform":function() {return "translate("+(d3.event.x+3)+","+(d3.event.y-10)+")";}
        })
...
//        console.log(hitted);
        ...
        columnTick.attr({
            x:function(d){return d.tickX-5;},
            y:function(d){return d.tickY;},
            height:function(d){return d.tickH;}
        })
